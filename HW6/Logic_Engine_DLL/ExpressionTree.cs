...
namespace CptS321
{
    ...
    public class ExpressionTree : Expression
    {
            ...
            if (operatorNode != null)
            {
                switch (operatorNode.Operator)
                {
                    ...
                    case '/':
                        ...
                        break;
                    default:
                        throw new NotSupportedException("Operator " + this.op.Operator.ToString() + "is not support.");
                }
        ...
        private OperatorNode Build(string s)
        {
            ...
            return (OperatorNode)operatorNode.Pop();
        }
    }
}
